<div>
                ...
                <div class="flex self-center flex-shrink-0" x-data="{ open: false }">
                    <div class="relative inline-block text-left">
                        ...
                        <div x-show="open" @click.away="open = false"
                            ...
                            {{-- Edit Post --}}
                            <a href="{{ route('posts.edit', $post->id) }}" wire:navigate class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem" tabindex="-1"
                                id="user-menu-item-0">Edit</a>

                            {{-- Delete Post --}}
                            <button wire:click="delete({{ $post->id }})" wire:confirm="Are you sure to delete this post?"
                                class="block w-full px-4 py-2 text-sm text-gray-700 text-start hover:bg-gray-100" role="menuitem" tabindex="-1"id="user-menu-item-1">
                                Delete
                            </button>
                        </div>
                    </div>
    ...
    <div class="py-4 font-normal text-gray-700">
        ...
        <a href="{{ route('posts.show', $post->id) }}" wire:navigate class="text-xs text-gray-600 hover:underline">View Post</a>
    </div>
